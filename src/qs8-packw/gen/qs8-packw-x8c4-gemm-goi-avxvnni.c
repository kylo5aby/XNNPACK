  ...
  do {
    ...
    for (; n >= 8; n -= 8) {
      ...
      for (; k >= 32; k -= 32) {
        ...
        const __m256i v01_0145 = _mm256_unpacklo_epi32(v0, v1);
        const __m256i v01_2367 = _mm256_unpackhi_epi32(v0, v1);
        const __m256i v23_0145 = _mm256_unpacklo_epi32(v2, v3);
        const __m256i v23_2367 = _mm256_unpackhi_epi32(v2, v3);
        const __m256i v45_0145 = _mm256_unpacklo_epi32(v4, v5);
        const __m256i v45_2367 = _mm256_unpackhi_epi32(v4, v5);
        const __m256i v67_0145 = _mm256_unpacklo_epi32(v6, v7);
        const __m256i v67_2367 = _mm256_unpackhi_epi32(v6, v7);
        ...
        vacc = _mm256_dpbusd_avx_epi32(vacc, vone, v04_0);
        vacc = _mm256_dpbusd_avx_epi32(vacc, vone, v04_1);
        vacc = _mm256_dpbusd_avx_epi32(vacc, vone, v15_0);
        vacc = _mm256_dpbusd_avx_epi32(vacc, vone, v15_1);
        vacc = _mm256_dpbusd_avx_epi32(vacc, vone, v26_0);
        vacc = _mm256_dpbusd_avx_epi32(vacc, vone, v26_1);
        vacc = _mm256_dpbusd_avx_epi32(vacc, vone, v37_0);
        vacc = _mm256_dpbusd_avx_epi32(vacc, vone, v37_1);
      ...
      for (; k >= 8; k -= 8) {
        ...
        const __m256i v0_0246 = _mm256_permutevar8x32_epi32(v0, permute_mask0);
        const __m256i v0_1357 = _mm256_permutevar8x32_epi32(v0, permute_mask1);
        const __m256i v4_0246 = _mm256_permutevar8x32_epi32(v4, permute_mask0);
        const __m256i v4_1357 = _mm256_permutevar8x32_epi32(v4, permute_mask1);

        const __m256i v04_0246 = _mm256_permute2f128_si256(v0_0246, v4_0246, 0x20);
        const __m256i v04_1357 = _mm256_permute2f128_si256(v0_1357, v4_1357, 0x20);

        vacc = _mm256_dpbusd_avx_epi32(vacc, vone, v04_0246);
        vacc = _mm256_dpbusd_avx_epi32(vacc, vone, v04_1357);

        _mm256_storeu_si256((__m256i *)&out[0],  v04_0246);
        _mm256_storeu_si256((__m256i *)&out[32],  v04_1357);
      ...
      for (; k >= 4; k -= 4) {
        ...
        vacc = _mm256_dpbusd_avx_epi32(vacc, vone, v0);
      ...
      if (k != 0) {
        assert(k >= 1 && k <= 3);
        const __m256i vmask = _mm256_set1_epi32((1u << (k * sizeof(int8_t))) - 1);
        __m256i v0 = _mm256_set1_epi32((int32_t) unaligned_load_u32(w0));
        v0 = _mm256_blend_epi32(v0, _mm256_set1_epi32((int32_t) unaligned_load_u32(w1)), 0x02);
        v0 = _mm256_blend_epi32(v0, _mm256_set1_epi32((int32_t) unaligned_load_u32(w2)), 0x04);
        v0 = _mm256_blend_epi32(v0, _mm256_set1_epi32((int32_t) unaligned_load_u32(w3)), 0x08);
    ...
    if XNN_UNLIKELY(n != 0) {
      ...
      vacc = _mm256_mullo_epi32(vacc, vzeropoint);
      __m256i vpack0 =  _mm256_loadu_si256((const __m256i*) (packed_b + 0));
      vpack0 = _mm256_sub_epi32(vpack0, vacc);
